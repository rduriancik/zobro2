  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        <AnimalText>
          Ahoj, jmenuji se Ivan a jsem rosomák. Narodil jsem se v&nbsp;roce 2008 v&nbsp;Norsku a do brněnské zoo jsem přicestoval ve dvou letech. Nataša – to je ta rosomačice, která se mnou obývá výběh – je o&nbsp;dva roky mladší než já a sem do Beringie přijela jen krátce po mně. Aby nenastala nějaká mýlka, já jsem z&nbsp;nás dvou ten menší. Nataša sice pochází až z&nbsp;Ruska, ale mezi námi rosomáky nebývají jazykové bariéry, takže jsme se rychle skamarádili. Dokonce natolik, že se nám 2.&nbsp;března 2016 narodil syn Vasil, který se tak stal prvním odchovaným mládětem rosomáka v&nbsp;Česku. Nečekaně brzy, jen jedenáct měsíců na to, jsme na svět přivedli rovnou trojčata – holky Jelenu a Tatyanu a kluka Vadima.
        </AnimalText>
        <AnimalText>
