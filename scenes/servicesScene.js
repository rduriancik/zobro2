      ...
      >
        <ScrollView minimumZoomScale={MIN_ZOOM} maximumZoomScale={MAX_ZOOM}
          ...
          <View style={{flex: 1, flexDirection: 'row', alignItems: 'center',
            paddingTop: PADDING/2, justifyContent: 'center'}}>
            <InPageImages
              sources={[
          ...
          <Text style={{textAlignVertical: 'center', fontWeight: 'bold', paddingTop: 15}}>
          ...
          <Text style={{textAlignVertical: 'center', paddingLeft: PADDING/2,
          ...
          <View style={{flex: 1, flexDirection: 'row', alignItems: 'center',
            paddingTop: PADDING/2, paddingBottom: PADDING, justifyContent: 'center'}}>
            <InPageImages
              sources={[
